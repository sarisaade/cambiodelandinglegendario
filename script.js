...
card.addEventListener("click", (e) => {
  ...
  abrirModalConCarrusel(p, imagenActual);
...
function activarColores() {
  ...
  card.querySelector(".add-to-cart").dataset.images
);

const nuevoIndex = imagenes.indexOf(btn.dataset.image);

img.dataset.index = nuevoIndex >= 0 ? nuevoIndex : 0;
